...
def LedColorSet1(r, g, b):
    ...
    pwm[0][1].ChangeDutyCycle((255 - r) / 2.55)
    pwm[0][2].ChangeDutyCycle((255 - r) / 2.55)

def LedColorSet2(r, g, b):
    pwm[1][0].ChangeDutyCycle((255 - r) / 2.55)
    pwm[1][1].ChangeDutyCycle((255 - r) / 2.55)
    pwm[1][2].ChangeDutyCycle((255 - r) / 2.55)

def LedColorSet3(r, g, b):
    pwm[2][0].ChangeDutyCycle((255 - r) / 2.55)
    pwm[2][1].ChangeDutyCycle((255 - r) / 2.55)
    pwm[2][2].ChangeDutyCycle((255 - r) / 2.55)
